...
from speckit_pro.engine.dag.orchestrator import DAGOrchestrator
...
def status():
    ...
    """
    from speckit_pro.memory.state.db import StateMachineDB
    db = StateMachineDB()
...
def dashboard():
    ...
    """
    from speckit_pro.cli.dashboard import render_dashboard
    render_dashboard()
